...
from Graphs.plot_parts import plot_loss_and_accuracy
...
def train_model(model,
    ...
    min_SNR = train_param["min_SNR"]
    max_SNR = train_param["max_SNR"]
    filename = f'{min_SNR}-{max_SNR}SNR loss curve'
    train_loss_save, train_acc_save, val_loss_save, val_acc_save = [], [], [], []
    ...
    for loss_param in train_loss_param_list:
        ...
        for epoch in range(epochs):
            ...
            # Saving for plotting the training curve
            train_loss_save.append(train_loss)
            train_acc_save.append(train_bbox_acc)  # Calculates the bbox accuracy and not the whole frame
            val_loss_save.append(valid_loss)
            val_acc_save.append(valid_bbox_acc)
    ...
    plot_loss_and_accuracy(train_loss_save, train_acc_save, val_loss_save, val_acc_save, filename)
